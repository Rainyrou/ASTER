...
##### Model Configuration ######
model_path=/root/ckpts/Aster_4B_maxturns_50_maxresp_16384_step405
model_name=Aster_4B
...
max_num_batched_tokens=$((max_prompt_length*4+max_response_length*4))
max_assistant_turns=50

##### Training Hyperparameters ######
train_bsz=128
ppo_mini_batch_size=64
ppo_max_token_len_per_gpu=$((max_prompt_length*2+max_response_length*2))
clip_ratio_low=0.2
...
python3 -m aster.main \
    ...
    2>&1 | tee "$save_path/train_4B_second_stage.log"
