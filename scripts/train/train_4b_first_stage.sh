...
##### Model Configuration ######
model_path=/root/ckpts/Qwen3-4B-Thinking-2507_SFT
model_name=Aster_4B

##### Dataset Configuration ######
train_datasets=$PROJECT_DIR/datasets/dapo.parquet
val_datasets="[$PROJECT_DIR/datasets/aime25.parquet,$PROJECT_DIR/datasets/hmmt25.parquet]"

##### Sequence Length Configuration ######
max_prompt_length=2048
max_response_length=16384
max_num_batched_tokens=$((max_prompt_length*8+max_response_length*8))
max_assistant_turns=50

##### Training Hyperparameters ######
train_bsz=128
ppo_mini_batch_size=64
ppo_max_token_len_per_gpu=$((max_prompt_length*4+max_response_length*4))
clip_ratio_low=0.2
...
python3 -m aster.main \
    ...
    2>&1 | tee "$save_path/train_4B.log"
