...
def test_python_fetch_files():
    request = RunCodeRequest(language='python',
                             ...
                             code='open("a.txt", "w").write("secret"); open("b", "w").write("sauce");',
                             run_timeout=5,
    ...
    assert base64.b64decode(result.files['b'].encode()).decode() == 'sauce'


if __name__ == '__main__':
    test_python_print()
    test_python_timeout()
    test_python_assertion_error()
    test_python_syntax_error()
    test_python_file_read()
    test_python_stdin()
    test_python_fetch_files()