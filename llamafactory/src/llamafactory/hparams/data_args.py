...
class DataArguments:
    ...
    ignore_empty_think: bool = field(
        default=False,
        metadata={"help": "If true, mask loss on empty <think>...</think> spans to protect reasoning."},
    )
    drop_exceeding_samples: bool = field(
        default=False,
        metadata={"help": "If true, drop samples exceeding cutoff_len instead of truncating them."},
    )
